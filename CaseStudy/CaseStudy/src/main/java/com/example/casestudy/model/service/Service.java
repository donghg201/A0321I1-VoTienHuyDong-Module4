...
public class Service {
    ...
    public Service(int service_id, String service_name, int service_area, double service_cost, int service_max_people, String standard_room, String description_other_convinience, double pool_area, int number_of_floors, RentType rentType, ServiceType serviceType, List<Contract> contractList) {
